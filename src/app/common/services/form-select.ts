export function FormSelect(jQuery) {
//自定义配置
  var options = {
  ...
  (function ($, opt) {
    ...
    function getKeyString(keycode, shiftkey) {
      var keyCodeArr = [{str: "0", shiftStr: ')', code: 48}, {str: "1", shiftStr: '!', code: 49}, {
          str: "2",
          shiftStr: '@',
          code: 50
        }, {str: "3", shiftStr: '#', code: 51}, {str: "4", shiftStr: '$', code: 52}, {
          str: "5",
          shiftStr: '%',
          code: 53
        }, {str: "6", shiftStr: '^', code: 54}, {str: "7", shiftStr: '&', code: 55}, {
          str: "8",
          shiftStr: '*',
          code: 56
        }, {str: "9", shiftStr: '(', code: 57}, {str: "a", shiftStr: 'A', code: 65}, {
          str: "b",
          shiftStr: 'B',
          code: 66
        }, {str: "c", shiftStr: 'C', code: 67}, {str: "d", shiftStr: 'D', code: 68}, {
          str: "e",
          shiftStr: 'E',
          code: 69
        }, {str: "f", shiftStr: 'F', code: 70}, {str: "g", shiftStr: 'G', code: 71}, {
          str: "h",
          shiftStr: 'H',
          code: 72
        }, {str: "i", shiftStr: 'I', code: 73}, {str: "j", shiftStr: 'J', code: 74}, {
          str: "k",
          shiftStr: 'K',
          code: 75
        }, {str: "l", shiftStr: 'L', code: 76}, {str: "m", shiftStr: 'M', code: 77}, {
          str: "n",
          shiftStr: 'N',
          code: 78
        }, {str: "o", shiftStr: 'O', code: 79}, {str: "p", shiftStr: 'P', code: 80}, {
          str: "q",
          shiftStr: 'Q',
          code: 81
        }, {str: "r", shiftStr: 'R', code: 82}, {str: "s", shiftStr: 'S', code: 83}, {
          str: "t",
          shiftStr: 'T',
          code: 84
        }, {str: "u", shiftStr: 'U', code: 85}, {str: "v", shiftStr: 'V', code: 86}, {
          str: "w",
          shiftStr: 'W',
          code: 87
        }, {str: "x", shiftStr: 'X', code: 88}, {str: "y", shiftStr: 'Y', code: 89}, {str: "z", shiftStr: 'Z', code: 90}],
        n = keyCodeArr.length,
        index = -1;
      for (var i = 0; i < n; i++) {
    ...
    $(document).on('click', selectSwitchBtnSelector, function (e) {
      var $thisSelect = $(this).parents(selectSelector);
      if (isDisabled($thisSelect)) {
        return
      }
      ;
